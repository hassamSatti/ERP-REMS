        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    {!! Form::model($sector, ['route' => ['sector.update', $sector->id], 'method'=>'PATCH','enctype'=>'multipart/form-data']) !!}
                    <div class="card-body row">
                        ...
                        <div class="col-md-4">
                                ...
                                <select id="project_id" name="project_id" class="select2 @error('project_id') is-invalid @enderror" >
                                    ...
                                    @foreach($project as $cou)
                                        <option  {{$cou->id==$sector->project_id ? 'selected':''}} value="{{ $cou->id }}">
                                            {{ $cou->name }}
                                        </option>
                                    @endforeach
                                </select> 
                        ...
                        <div class="col-md-4">
                            ...
                            name="name" value="{{ old('name')?? $sector->name }}" autocomplete="name" autofocus placeholder="Name">
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-4">
                                ...
                                name="detail" value="{{ old('detail')?? $sector->detail  }}" autocomplete="detail" 
