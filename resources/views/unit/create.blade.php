                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select onChange="sector(this.value)" id="project_id" name="project_id" class="select2 @error('project_id') is-invalid @enderror" >
                                    ...
                                    @foreach($project as $cou)
                                        <option  {{ $cou->id == old('project_id') ? 'selected' : ''}} value="{{$cou->id }}">
                                            {{ $cou->name }}
                                        </option>
                                    @endforeach
                                </select> 
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="size_id" name="size_id" class="select2 @error('size_id') is-invalid @enderror" >
                                    ...
                                    @foreach($size as $cou)
                                        <option  {{ $cou->id == old('size_id') ? 'selected' : ''}} value="{{$cou->id }}">
                                            {{ $cou->name }}
                                        </option>
                                    @endforeach
                                </select> 
                            ...
                            <div class="col-md-4">
                                ...
                                name="name" value="{{ old('name') }}" autocomplete="name" autofocus placeholder="Unit #">
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="type" name="type" class="select2 @error('type') is-invalid @enderror" >
                                    ...
                                    <option {{ 1 == old('type') ? 'selected' : ''}} value="1">Residential</option>
                                    <option {{ 2 == old('type') ? 'selected' : ''}} value="2">Commercial</option> 
                                </select> 
                                @error('type')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="category" name="category" class="select2 @error('category') is-invalid @enderror" >
                                    ...
                                    <option {{ 1 == old('category') ? 'selected' : ''}} value="1">File</option>
                                    <option {{ 2 == old('category') ? 'selected' : ''}} value="2">Plot</option> 
                                    <option {{ 3 == old('category') ? 'selected' : ''}} value="3">Shop</option> 
                                    <option {{ 4 == old('category') ? 'selected' : ''}} value="4">Apartment</option> 
                                    <option {{ 5 == old('category') ? 'selected' : ''}} value="5">Office</option> 
                                </select> 
                                @error('category')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-4">
                                ...
                                name="price" value="{{ old('price') }}" autocomplete="price" autofocus placeholder="Price">
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
    ...
    $.ajax({
        ...
        success: function(res) 
        {
            if (res) 
            {
                ...
                {
                    $("#sector_id").append('<option value="' + key + '">' + value +'</option>');
                });
            } 
            else 
            {
